...
ms_if_exists "./data/raw/msl/${layer_slug}.zip" \
    ...
    -o gj2008 data/processed/original-resolution/${layer_slug}-secondary.geojson target=secondary \
    -o gj2008 data/processed/original-resolution/${layer_slug}-unified.geojson target=unified \
